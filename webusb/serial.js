/*********************************************************************
 ...
 Adapted from https://adafruit.github.io/Adafruit_TinyUSB_Arduino/examples/webusb-rgb/serial.js
*********************************************************************/
...
(function() {
  ...
  serial.Port.prototype.receive = function(len) {
    return this.device_.transferIn(this.endpointOut, len);
  };
